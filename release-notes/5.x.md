...
SQS Extended Client can be configured by adding a bucketName to the queue configuration


# 5.4.0-beta

SNS Extended Client can be configured by adding a bucketName to the topic configuration
