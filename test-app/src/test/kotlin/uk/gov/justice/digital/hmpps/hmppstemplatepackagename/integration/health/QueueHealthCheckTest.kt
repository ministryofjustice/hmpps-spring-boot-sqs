...
class QueueHealthCheckTest : IntegrationTestBase() {
  ...
  fun `Main queue health ok`() {
    ...
    webTestClient.get()
      ...
      .jsonPath("components.mainqueue-health.details.queueName").isEqualTo(hmppsSqsProperties.mainQueueConfig().queueName)
      ...
      .jsonPath("components.mainqueue-health.details.dlqName").isEqualTo(hmppsSqsProperties.mainQueueConfig().dlqName)
  ...
  fun `Another queue health ok`() {
    ...
    webTestClient.get()
      ...
      .jsonPath("components.anotherqueue-health.details.queueName").isEqualTo(hmppsSqsProperties.anotherQueueConfig().queueName)
      ...
      .jsonPath("components.anotherqueue-health.details.dlqName").isEqualTo(hmppsSqsProperties.anotherQueueConfig().dlqName)
